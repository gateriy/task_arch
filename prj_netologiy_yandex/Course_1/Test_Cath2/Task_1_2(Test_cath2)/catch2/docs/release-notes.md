...
|:------------------------------------------- | ------------:| -------------:|
| Run 1M `REQUIRE(true)`                      |  1.10 В± 0.01 |   1.02 В± 0.06 |
| Run 100 tests, 3^3 sections, 1 REQUIRE each |  1.27 В± 0.01 |   1.04 В± 0.01 |
| Run 3k tests, no names, no tags             |  1.29 В± 0.01 |   1.05 В± 0.01 |
| Run 3k tests, names, tags                   |  1.49 В± 0.01 |   1.22 В± 0.01 |
| Run 1 out of 3k tests no names, no tags     |  1.68 В± 0.02 |   1.19 В± 0.22 |
| Run 1 out of 3k tests, names, tags          |  1.79 В± 0.02 |   2.06 В± 0.23 |
