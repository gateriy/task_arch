п»ї// find_epsilon.cpp : Р­С‚РѕС‚ С„Р°Р№Р» СЃРѕРґРµСЂР¶РёС‚ С„СѓРЅРєС†РёСЋ "main". Р—РґРµСЃСЊ РЅР°С‡РёРЅР°РµС‚СЃСЏ Рё Р·Р°РєР°РЅС‡РёРІР°РµС‚СЃСЏ РІС‹РїРѕР»РЅРµРЅРёРµ РїСЂРѕРіСЂР°РјРјС‹.
#include <algorithm>
#include <cmath>
#include <iostream>
#include <map>
...
/*    search_server.SetStopWords("Рё РІ РЅР°"s);
    ...
    for (const Document& document : search_server.FindTopDocuments("СѓС…РѕР¶РµРЅРЅС‹Р№ РєРѕС‚"s)) {
